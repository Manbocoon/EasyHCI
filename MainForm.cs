...
namespace EasyHCI
{
    public partial class MainForm : MaterialSkin.Controls.MaterialForm
    {
        ...
        { //테스트 시작버튼
            ...
            if (MessageBox.Show("제대로 된 부하 테스트를 위해서는 불필요한 프로세스를 모두 종료해야합니다.\r\n불필요한 모든 프로세스를 종료하시겠습니까?\r\n\r\n※중요한 작업을 하고 있다면 미리 백업해주십시오.", "메모리 정리", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                cleanMemory();
            }
        ...
        { //프로그램 시작 시 모든 작업 완료 전까지 잠시 숨김
            ...
            if (!Directory.Exists(Application.StartupPath + "\\HCI Screenshots")) {
